  ...
  const [applicationListDetails, setApplicationListDetails] = useState([
    {
      ...
      id: 2,
      description: 'Підставою для надання здобувачу вищої освіти права на повторне навчання може бути невиконання ним, до початку екзаменаційної сесії, навчального плану поточного семестру з поважних причин, які підтверджені відповідними документами.',
      file: 'http://web.kpi.kharkov.ua/infiz/wp-content/uploads/sites/59/2020/11/BLANK-ZAYAVY.pdf',
      ...
      id: 4,
      description: 'Відрахування здобувачів вищої освіти оформлюється наказом за підписом ректора (проректора з науково-педагогічної роботи) на підставі подання заяви від здобувача  з резолюцією директора інституту, що засвідчує згоду на відрахування. ',
      file: 'http://web.kpi.kharkov.ua/infiz/wp-content/uploads/sites/59/2020/11/BLANK-ZAYAVY.pdf',
      fileName: 'Бланк заяви на відрахування за власним бажанням',
    }, {
      name: 'Поновлення до складу студентів (після відрахування)',
      id: 5,
      description: 'Поновленими до  складу здобувачів вищої освіти НТУ “ХПІ” можуть бути особи, які відраховані до завершення навчання за освітньою (освітньо-професійною, освітньо-науковою) програмою відповідного рівня вищої освіти.',
      file: 'http://web.kpi.kharkov.ua/infiz/wp-content/uploads/sites/59/2020/11/BLANK-ZAYAVY.pdf',
      ...
      id: 9,
      description: 'Заяви оформлюються студентом особисто від руки, візуються директором інституту та передаються на підпис проректору.',
      file: 'http://web.kpi.kharkov.ua/infiz/wp-content/uploads/sites/59/2020/12/Zayavy-zrazky-dlya-znyattya-kopiyi.pdf',
      fileName: 'Бланк заяви на зняття копії документів, що знаходяться у відділі кадрів',
    }, {
      ...
      id: 12,
      description: 'Перезарахування навчальних дисциплін здійснює  директор інституту, з обовя’зковою згодою викладача дисципліни.',
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text
            onPress={() => {Linking.openURL(applicationListDetails[apllicationId].file)}}
            style={{
              fontSize: 16,
              color: 'blue',
              margin: 10,
